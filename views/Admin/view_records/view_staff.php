...
<head>
    ...
    <title>UNZA - Graduation Clearance System | Admin</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation" style="width:210px;">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="divider"></li>
                    <li >
                        <a href="view_students.php"><i class="fa fa-minus fa-fw"></i>Delete Student</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                    ...
                    <li class="divider"></li>
                    <li class="selected">
                        <a href="view_staff.php"><i class="fa fa-minus fa-fw"></i>Delete Staff</a>
                    </li> 
        ...
        <div id="page-wrapper" style="margin-left:210px; background-color:#ffffff;">        
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Archive Staff Records </h1>
                </div>
                 <!-- end  page header -->
            </div>
            <?php include_once('../../../data_modules/loadStaff.php');?>
            <div class="row">
                <div class="col-lg-12">
                    <!-- Advanced Tables -->
