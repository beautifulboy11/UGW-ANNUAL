            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper" style=" background-color:#ffffff;">        
                    <section class="content-header">
                        ...
                        <h1 class="page-header text-center">Contributions Without Comments</h1>

                        
                    </section>
                    <?php include_once('../../model/uncommentedArticles.php'); ?>
                    <section class="content">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <iframe src="index.php" scrolling="no" frameborder="0" height="780px" width="100%"></iframe>
                                    </div>
                                </div>
                                <!--End Advanced Tables -->
                            </div>
