                        ...
                        <div class="panel-body" style="padding-left:100px; min-height:780px;">
                            ...
                            <?php                        
                              //$student_Id = $_GET['studentId'];
                                ...
                                // mysql select query
                                $query = "SELECT cf.clearance_id,cf.student_id,CONCAT(cf.first_name,' ',cf.last_name)AS student_Name,
                            ...
                            <table id="dynamic" class="table">
                                <tr>
                                    ...
                                    <td><button id="approvebtn" class="btn btn-success" style="margin-left:200px;">Approve Application</button>
                                        <button id="declinebtn" class="btn btn-danger" style="margin-right:100px; margin-left:100px;">Decline Application</button></td>
                                </tr>
                            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {  
                ...
                $('#submit').click(function(){                                     
                    ...
                    if(decision == true){
                    $.ajax({
                        url:"../../data_modules/school/deanclearance.php",
                        method:"POST",
                        data:postData,
